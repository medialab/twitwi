...
class BlueskyPost(TypedDict):
    ...
    card_title: Optional[str]           # title of the webpage corresponding to the linkg displayed as a card within the post if any
    card_description: Optional[str]     # description of the webpage corresponding to the linkg displayed as a card within the post if any
    card_thumbnail: Optional[str]       # image displayed as an illustration of the webpage corresponding to the link displayed as a card within the post if any
