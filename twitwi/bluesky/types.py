...
class BlueskyPost(TypedDict):
    ...
    repost_by_user_did: Optional[str]
    repost_by_user_handle: Optional[str]
    repost_created_at: Optional[int]
    repost_timestamp_utc: Optional[int]
    ...
    quoted_created_at: Optional[int]
